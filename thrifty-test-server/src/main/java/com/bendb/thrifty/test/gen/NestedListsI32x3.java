...
public class NestedListsI32x3
        implements org.apache.thrift.TBase<NestedListsI32x3, NestedListsI32x3._Fields>,
                java.io.Serializable,
                Cloneable,
                Comparable<NestedListsI32x3> {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC =
            new org.apache.thrift.protocol.TStruct("NestedListsI32x3");

    private static final org.apache.thrift.protocol.TField INTEGERLIST_FIELD_DESC =
            new org.apache.thrift.protocol.TField("integerlist", org.apache.thrift.protocol.TType.LIST, (short) 1);

    private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY =
            new NestedListsI32x3StandardSchemeFactory();
    private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY =
            new NestedListsI32x3TupleSchemeFactory();

    public @org.apache.thrift.annotation.Nullable java.util.List<java.util.List<java.util.List<java.lang.Integer>>>
            integerlist; // required
    ...
    public NestedListsI32x3(java.util.List<java.util.List<java.util.List<java.lang.Integer>>> integerlist) {
        this();
    ...
    public NestedListsI32x3(NestedListsI32x3 other) {
        if (other.isSetIntegerlist()) {
            java.util.List<java.util.List<java.util.List<java.lang.Integer>>> __this__integerlist =
                    new java.util.ArrayList<java.util.List<java.util.List<java.lang.Integer>>>(
                            other.integerlist.size());
            for (java.util.List<java.util.List<java.lang.Integer>> other_element : other.integerlist) {
                java.util.List<java.util.List<java.lang.Integer>> __this__integerlist_copy =
                        new java.util.ArrayList<java.util.List<java.lang.Integer>>(other_element.size());
                for (java.util.List<java.lang.Integer> other_element_element : other_element) {
                    java.util.List<java.lang.Integer> __this__integerlist_copy_copy =
                            new java.util.ArrayList<java.lang.Integer>(other_element_element);
    ...
    public NestedListsI32x3 setIntegerlist(
            @org.apache.thrift.annotation.Nullable
    ...
    public boolean equals(java.lang.Object that) {
        if (that instanceof NestedListsI32x3) return this.equals((NestedListsI32x3) that);
        return false;
    }
    ...
    public boolean equals(NestedListsI32x3 that) {
        ...
        if (this_present_integerlist || that_present_integerlist) {
            if (!(this_present_integerlist && that_present_integerlist)) return false;
            if (!this.integerlist.equals(that.integerlist)) return false;
        }
    ...
    public int hashCode() {
        ...
        if (isSetIntegerlist()) hashCode = hashCode * 8191 + integerlist.hashCode();
    ...
    private static class NestedListsI32x3StandardScheme
            extends org.apache.thrift.scheme.StandardScheme<NestedListsI32x3> {

        @Override
        public void read(org.apache.thrift.protocol.TProtocol iprot, NestedListsI32x3 struct)
                        ...
                        if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                            {
                                ...
                                struct.integerlist = new java.util.ArrayList<
                                        java.util.List<java.util.List<java.lang.Integer>>>(_list172.size);
                                @org.apache.thrift.annotation.Nullable
                                ...
                                for (int _i174 = 0; _i174 < _list172.size; ++_i174) {
                                    {
                                        ...
                                        _elem173 = new java.util.ArrayList<java.util.List<java.lang.Integer>>(
                                                _list175.size);
                                        @org.apache.thrift.annotation.Nullable
        ...
        @Override
        public void write(org.apache.thrift.protocol.TProtocol oprot, NestedListsI32x3 struct)
                throws org.apache.thrift.TException {
            struct.validate();
            ...
            if (struct.integerlist != null) {
                oprot.writeFieldBegin(INTEGERLIST_FIELD_DESC);
                {
                    oprot.writeListBegin(new org.apache.thrift.protocol.TList(
                            org.apache.thrift.protocol.TType.LIST, struct.integerlist.size()));
                    for (java.util.List<java.util.List<java.lang.Integer>> _iter181 : struct.integerlist) {
                        {
                            oprot.writeListBegin(new org.apache.thrift.protocol.TList(
                                    org.apache.thrift.protocol.TType.LIST, _iter181.size()));
                            for (java.util.List<java.lang.Integer> _iter182 : _iter181) {
                                {
                                    oprot.writeListBegin(new org.apache.thrift.protocol.TList(
                                            org.apache.thrift.protocol.TType.I32, _iter182.size()));
    ...
    private static class NestedListsI32x3TupleScheme extends org.apache.thrift.scheme.TupleScheme<NestedListsI32x3> {
        ...
        @Override
        public void write(org.apache.thrift.protocol.TProtocol prot, NestedListsI32x3 struct)
                throws org.apache.thrift.TException {
        ...
        @Override
        public void read(org.apache.thrift.protocol.TProtocol prot, NestedListsI32x3 struct)
                throws org.apache.thrift.TException {
            org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
            java.util.BitSet incoming = iprot.readBitSet(1);
            if (incoming.get(0)) {
                {
                    org.apache.thrift.protocol.TList _list187 =
                            iprot.readListBegin(org.apache.thrift.protocol.TType.LIST);
                    struct.integerlist =
                            new java.util.ArrayList<java.util.List<java.util.List<java.lang.Integer>>>(_list187.size);
                    ...
                    for (int _i189 = 0; _i189 < _list187.size; ++_i189) {
                        {
                            ...
                            for (int _i192 = 0; _i192 < _list190.size; ++_i192) {
                                {
                                    org.apache.thrift.protocol.TList _list193 =
