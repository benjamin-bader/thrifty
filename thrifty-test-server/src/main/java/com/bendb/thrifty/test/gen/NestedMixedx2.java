...
public class NestedMixedx2
        implements org.apache.thrift.TBase<NestedMixedx2, NestedMixedx2._Fields>,
                java.io.Serializable,
                Cloneable,
                Comparable<NestedMixedx2> {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC =
            new org.apache.thrift.protocol.TStruct("NestedMixedx2");

    private static final org.apache.thrift.protocol.TField INT_SET_LIST_FIELD_DESC =
            new org.apache.thrift.protocol.TField("int_set_list", org.apache.thrift.protocol.TType.LIST, (short) 1);
    private static final org.apache.thrift.protocol.TField MAP_INT_STRSET_FIELD_DESC =
            new org.apache.thrift.protocol.TField("map_int_strset", org.apache.thrift.protocol.TType.MAP, (short) 2);
    private static final org.apache.thrift.protocol.TField MAP_INT_STRSET_LIST_FIELD_DESC =
            new org.apache.thrift.protocol.TField(
                    "map_int_strset_list", org.apache.thrift.protocol.TType.LIST, (short) 3);

    private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY =
            new NestedMixedx2StandardSchemeFactory();
    private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY =
            new NestedMixedx2TupleSchemeFactory();

    public @org.apache.thrift.annotation.Nullable java.util.List<java.util.Set<java.lang.Integer>>
            int_set_list; // required
    public @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.Integer, java.util.Set<java.lang.String>>
            map_int_strset; // required
    ...
    public NestedMixedx2(NestedMixedx2 other) {
        if (other.isSetInt_set_list()) {
            java.util.List<java.util.Set<java.lang.Integer>> __this__int_set_list =
                    new java.util.ArrayList<java.util.Set<java.lang.Integer>>(other.int_set_list.size());
            for (java.util.Set<java.lang.Integer> other_element : other.int_set_list) {
                java.util.Set<java.lang.Integer> __this__int_set_list_copy =
                        new java.util.HashSet<java.lang.Integer>(other_element);
                __this__int_set_list.add(__this__int_set_list_copy);
            }
            this.int_set_list = __this__int_set_list;
        }
        if (other.isSetMap_int_strset()) {
            java.util.Map<java.lang.Integer, java.util.Set<java.lang.String>> __this__map_int_strset =
                    new java.util.HashMap<java.lang.Integer, java.util.Set<java.lang.String>>(
                            other.map_int_strset.size());
            for (java.util.Map.Entry<java.lang.Integer, java.util.Set<java.lang.String>> other_element :
                    other.map_int_strset.entrySet()) {
                ...
                java.util.Set<java.lang.String> __this__map_int_strset_copy_value =
                        new java.util.HashSet<java.lang.String>(other_element_value);
        ...
        if (other.isSetMap_int_strset_list()) {
            java.util.List<java.util.Map<java.lang.Integer, java.util.Set<java.lang.String>>>
                    __this__map_int_strset_list =
                            new java.util.ArrayList<java.util.Map<java.lang.Integer, java.util.Set<java.lang.String>>>(
                                    other.map_int_strset_list.size());
            for (java.util.Map<java.lang.Integer, java.util.Set<java.lang.String>> other_element :
                    other.map_int_strset_list) {
                java.util.Map<java.lang.Integer, java.util.Set<java.lang.String>> __this__map_int_strset_list_copy =
                        new java.util.HashMap<java.lang.Integer, java.util.Set<java.lang.String>>(other_element.size());
                for (java.util.Map.Entry<java.lang.Integer, java.util.Set<java.lang.String>> other_element_element :
                    ...
                    java.util.Set<java.lang.String> __this__map_int_strset_list_copy_copy_value =
                            new java.util.HashSet<java.lang.String>(other_element_element_value);

                    __this__map_int_strset_list_copy.put(
                            __this__map_int_strset_list_copy_copy_key, __this__map_int_strset_list_copy_copy_value);
                }
    ...
    public NestedMixedx2 setInt_set_list(
            @org.apache.thrift.annotation.Nullable java.util.List<java.util.Set<java.lang.Integer>> int_set_list) {
        this.int_set_list = int_set_list;
        return this;
    }
    ...
    public NestedMixedx2 setMap_int_strset(
            @org.apache.thrift.annotation.Nullable
                    java.util.Map<java.lang.Integer, java.util.Set<java.lang.String>> map_int_strset) {
        this.map_int_strset = map_int_strset;
        return this;
    ...
    @org.apache.thrift.annotation.Nullable
    public java.util.Iterator<java.util.Map<java.lang.Integer, java.util.Set<java.lang.String>>>
    ...
    public NestedMixedx2 setMap_int_strset_list(
            @org.apache.thrift.annotation.Nullable
                    java.util.List<java.util.Map<java.lang.Integer, java.util.Set<java.lang.String>>>
                            map_int_strset_list) {
        this.map_int_strset_list = map_int_strset_list;
            ...
            case MAP_INT_STRSET_LIST:
                if (value == null) {
                    ...
                    setMap_int_strset_list(
                            (java.util.List<java.util.Map<java.lang.Integer, java.util.Set<java.lang.String>>>) value);
                }
                break;
        }
    }
    ...
    public boolean equals(java.lang.Object that) {
        if (that instanceof NestedMixedx2) return this.equals((NestedMixedx2) that);
        return false;
    }
    ...
    public boolean equals(NestedMixedx2 that) {
        ...
        if (this_present_int_set_list || that_present_int_set_list) {
            if (!(this_present_int_set_list && that_present_int_set_list)) return false;
            if (!this.int_set_list.equals(that.int_set_list)) return false;
        }
        ...
        if (this_present_map_int_strset || that_present_map_int_strset) {
            if (!(this_present_map_int_strset && that_present_map_int_strset)) return false;
            if (!this.map_int_strset.equals(that.map_int_strset)) return false;
        }
        ...
        if (this_present_map_int_strset_list || that_present_map_int_strset_list) {
            if (!(this_present_map_int_strset_list && that_present_map_int_strset_list)) return false;
            if (!this.map_int_strset_list.equals(that.map_int_strset_list)) return false;
        }
    ...
    public int hashCode() {
        ...
        if (isSetInt_set_list()) hashCode = hashCode * 8191 + int_set_list.hashCode();

        hashCode = hashCode * 8191 + ((isSetMap_int_strset()) ? 131071 : 524287);
        if (isSetMap_int_strset()) hashCode = hashCode * 8191 + map_int_strset.hashCode();

        hashCode = hashCode * 8191 + ((isSetMap_int_strset_list()) ? 131071 : 524287);
        if (isSetMap_int_strset_list()) hashCode = hashCode * 8191 + map_int_strset_list.hashCode();
    ...
    public int compareTo(NestedMixedx2 other) {
        ...
        if (isSetMap_int_strset_list()) {
            lastComparison =
                    org.apache.thrift.TBaseHelper.compareTo(this.map_int_strset_list, other.map_int_strset_list);
            if (lastComparison != 0) {
                return lastComparison;
            }
        }
    ...
    private static class NestedMixedx2StandardScheme extends org.apache.thrift.scheme.StandardScheme<NestedMixedx2> {
        ...
        @Override
        public void read(org.apache.thrift.protocol.TProtocol iprot, NestedMixedx2 struct)
                        ...
                        if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                            {
                                ...
                                struct.int_set_list =
                                        new java.util.ArrayList<java.util.Set<java.lang.Integer>>(_list196.size);
                        ...
                        if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                            {
                                ...
                                struct.map_int_strset = new java.util.HashMap<
                                        java.lang.Integer, java.util.Set<java.lang.String>>(2 * _map202.size);
                                int _key203;
                        ...
                        if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                            {
                                ...
                                struct.map_int_strset_list = new java.util.ArrayList<
                                        java.util.Map<java.lang.Integer, java.util.Set<java.lang.String>>>(
                                        _list209.size);
                                @org.apache.thrift.annotation.Nullable
                                ...
                                for (int _i211 = 0; _i211 < _list209.size; ++_i211) {
                                    {
                                        ...
                                        _elem210 = new java.util.HashMap<
                                                java.lang.Integer, java.util.Set<java.lang.String>>(2 * _map212.size);
                                        int _key213;
        ...
        @Override
        public void write(org.apache.thrift.protocol.TProtocol oprot, NestedMixedx2 struct)
                throws org.apache.thrift.TException {
            struct.validate();
            ...
            if (struct.map_int_strset != null) {
                oprot.writeFieldBegin(MAP_INT_STRSET_FIELD_DESC);
                {
                    oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(
                            org.apache.thrift.protocol.TType.I32,
                            org.apache.thrift.protocol.TType.SET,
                            struct.map_int_strset.size()));
                    for (java.util.Map.Entry<java.lang.Integer, java.util.Set<java.lang.String>> _iter221 :
                            struct.map_int_strset.entrySet()) {
                        oprot.writeI32(_iter221.getKey());
                        {
                            oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(
                                    org.apache.thrift.protocol.TType.STRING,
                                    _iter221.getValue().size()));
            ...
            if (struct.map_int_strset_list != null) {
                ...
                {
                    oprot.writeListBegin(new org.apache.thrift.protocol.TList(
                            org.apache.thrift.protocol.TType.MAP, struct.map_int_strset_list.size()));
                    for (java.util.Map<java.lang.Integer, java.util.Set<java.lang.String>> _iter223 :
                            struct.map_int_strset_list) {
                        {
                            oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(
                                    org.apache.thrift.protocol.TType.I32,
                                    org.apache.thrift.protocol.TType.SET,
                                    _iter223.size()));
                            for (java.util.Map.Entry<java.lang.Integer, java.util.Set<java.lang.String>> _iter224 :
                                    _iter223.entrySet()) {
                                oprot.writeI32(_iter224.getKey());
                                {
                                    oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(
                                            org.apache.thrift.protocol.TType.STRING,
                                            _iter224.getValue().size()));
    ...
    private static class NestedMixedx2TupleScheme extends org.apache.thrift.scheme.TupleScheme<NestedMixedx2> {
        ...
        @Override
        public void write(org.apache.thrift.protocol.TProtocol prot, NestedMixedx2 struct)
                throws org.apache.thrift.TException {
            ...
            if (struct.isSetMap_int_strset()) {
                {
                    ...
                    for (java.util.Map.Entry<java.lang.Integer, java.util.Set<java.lang.String>> _iter228 :
                            struct.map_int_strset.entrySet()) {
            ...
            if (struct.isSetMap_int_strset_list()) {
                {
                    ...
                    for (java.util.Map<java.lang.Integer, java.util.Set<java.lang.String>> _iter230 :
                            struct.map_int_strset_list) {
                        {
                            oprot.writeI32(_iter230.size());
                            for (java.util.Map.Entry<java.lang.Integer, java.util.Set<java.lang.String>> _iter231 :
                                    _iter230.entrySet()) {
        ...
        @Override
        public void read(org.apache.thrift.protocol.TProtocol prot, NestedMixedx2 struct)
                throws org.apache.thrift.TException {
            ...
            if (incoming.get(0)) {
                {
                    org.apache.thrift.protocol.TList _list233 =
                            iprot.readListBegin(org.apache.thrift.protocol.TType.SET);
                    ...
                    for (int _i235 = 0; _i235 < _list233.size; ++_i235) {
                        {
                            org.apache.thrift.protocol.TSet _set236 =
                                    iprot.readSetBegin(org.apache.thrift.protocol.TType.I32);
            ...
            if (incoming.get(1)) {
                {
                    org.apache.thrift.protocol.TMap _map239 = iprot.readMapBegin(
                            org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.SET);
                    struct.map_int_strset =
                            new java.util.HashMap<java.lang.Integer, java.util.Set<java.lang.String>>(2 * _map239.size);
                    int _key240;
                    ...
                    for (int _i242 = 0; _i242 < _map239.size; ++_i242) {
                        ...
                        {
                            org.apache.thrift.protocol.TSet _set243 =
            ...
            if (incoming.get(2)) {
                {
                    org.apache.thrift.protocol.TList _list246 =
                            iprot.readListBegin(org.apache.thrift.protocol.TType.MAP);
                    struct.map_int_strset_list = new java.util.ArrayList<
                            java.util.Map<java.lang.Integer, java.util.Set<java.lang.String>>>(_list246.size);
                    @org.apache.thrift.annotation.Nullable
                    java.util.Map<java.lang.Integer, java.util.Set<java.lang.String>> _elem247;
                    for (int _i248 = 0; _i248 < _list246.size; ++_i248) {
                        {
                            org.apache.thrift.protocol.TMap _map249 = iprot.readMapBegin(
                                    org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.SET);
                            _elem247 = new java.util.HashMap<java.lang.Integer, java.util.Set<java.lang.String>>(
                                    2 * _map249.size);
                            int _key250;
                            ...
                            for (int _i252 = 0; _i252 < _map249.size; ++_i252) {
                                ...
                                {
                                    org.apache.thrift.protocol.TSet _set253 =
                                            iprot.readSetBegin(org.apache.thrift.protocol.TType.STRING);
