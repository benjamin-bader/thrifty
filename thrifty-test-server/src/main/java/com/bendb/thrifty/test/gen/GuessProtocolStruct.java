...
public class GuessProtocolStruct
        implements org.apache.thrift.TBase<GuessProtocolStruct, GuessProtocolStruct._Fields>,
                java.io.Serializable,
                Cloneable,
                Comparable<GuessProtocolStruct> {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC =
            new org.apache.thrift.protocol.TStruct("GuessProtocolStruct");

    private static final org.apache.thrift.protocol.TField MAP_FIELD_FIELD_DESC =
            new org.apache.thrift.protocol.TField("map_field", org.apache.thrift.protocol.TType.MAP, (short) 7);

    private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY =
            new GuessProtocolStructStandardSchemeFactory();
    private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY =
            new GuessProtocolStructTupleSchemeFactory();
    ...
    public GuessProtocolStruct(java.util.Map<java.lang.String, java.lang.String> map_field) {
        this();
    ...
    public GuessProtocolStruct(GuessProtocolStruct other) {
        if (other.isSetMap_field()) {
            java.util.Map<java.lang.String, java.lang.String> __this__map_field =
                    new java.util.HashMap<java.lang.String, java.lang.String>(other.map_field);
    ...
    public GuessProtocolStruct setMap_field(
            @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String, java.lang.String> map_field) {
        this.map_field = map_field;
        return this;
    }
    ...
    public boolean equals(java.lang.Object that) {
        if (that instanceof GuessProtocolStruct) return this.equals((GuessProtocolStruct) that);
        return false;
    }
    ...
    public boolean equals(GuessProtocolStruct that) {
        ...
        if (this_present_map_field || that_present_map_field) {
            if (!(this_present_map_field && that_present_map_field)) return false;
            if (!this.map_field.equals(that.map_field)) return false;
        }
    ...
    public int hashCode() {
        ...
        if (isSetMap_field()) hashCode = hashCode * 8191 + map_field.hashCode();
    ...
    private static class GuessProtocolStructStandardScheme
            extends org.apache.thrift.scheme.StandardScheme<GuessProtocolStruct> {

        @Override
        public void read(org.apache.thrift.protocol.TProtocol iprot, GuessProtocolStruct struct)
                        ...
                        if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                            {
                                ...
                                struct.map_field =
                                        new java.util.HashMap<java.lang.String, java.lang.String>(2 * _map130.size);
        ...
        @Override
        public void write(org.apache.thrift.protocol.TProtocol oprot, GuessProtocolStruct struct)
                throws org.apache.thrift.TException {
            struct.validate();
            ...
            if (struct.map_field != null) {
                oprot.writeFieldBegin(MAP_FIELD_FIELD_DESC);
                {
                    oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(
                            org.apache.thrift.protocol.TType.STRING,
                            org.apache.thrift.protocol.TType.STRING,
                            struct.map_field.size()));
                    for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter134 :
                            struct.map_field.entrySet()) {
    ...
    private static class GuessProtocolStructTupleScheme
            extends org.apache.thrift.scheme.TupleScheme<GuessProtocolStruct> {

        @Override
        public void write(org.apache.thrift.protocol.TProtocol prot, GuessProtocolStruct struct)
                throws org.apache.thrift.TException {
            ...
            if (struct.isSetMap_field()) {
                {
                    ...
                    for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter135 :
                            struct.map_field.entrySet()) {
        ...
        @Override
        public void read(org.apache.thrift.protocol.TProtocol prot, GuessProtocolStruct struct)
                throws org.apache.thrift.TException {
