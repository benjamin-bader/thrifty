...
public class NestedListsBonk
        implements org.apache.thrift.TBase<NestedListsBonk, NestedListsBonk._Fields>,
                java.io.Serializable,
                Cloneable,
                Comparable<NestedListsBonk> {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC =
            new org.apache.thrift.protocol.TStruct("NestedListsBonk");

    private static final org.apache.thrift.protocol.TField BONK_FIELD_DESC =
            new org.apache.thrift.protocol.TField("bonk", org.apache.thrift.protocol.TType.LIST, (short) 1);

    private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY =
            new NestedListsBonkStandardSchemeFactory();
    private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY =
            new NestedListsBonkTupleSchemeFactory();
    ...
    public NestedListsBonk(java.util.List<java.util.List<java.util.List<Bonk>>> bonk) {
        this();
        this.bonk = bonk;
    }
    ...
    public NestedListsBonk(NestedListsBonk other) {
        if (other.isSetBonk()) {
            java.util.List<java.util.List<java.util.List<Bonk>>> __this__bonk =
                    new java.util.ArrayList<java.util.List<java.util.List<Bonk>>>(other.bonk.size());
            for (java.util.List<java.util.List<Bonk>> other_element : other.bonk) {
                java.util.List<java.util.List<Bonk>> __this__bonk_copy =
                        new java.util.ArrayList<java.util.List<Bonk>>(other_element.size());
                for (java.util.List<Bonk> other_element_element : other_element) {
                    java.util.List<Bonk> __this__bonk_copy_copy =
                            new java.util.ArrayList<Bonk>(other_element_element.size());
    ...
    public NestedListsBonk setBonk(
            @org.apache.thrift.annotation.Nullable java.util.List<java.util.List<java.util.List<Bonk>>> bonk) {
        this.bonk = bonk;
        return this;
    }
    ...
    public boolean equals(java.lang.Object that) {
        if (that instanceof NestedListsBonk) return this.equals((NestedListsBonk) that);
        return false;
    }
    ...
    public boolean equals(NestedListsBonk that) {
        ...
        if (this_present_bonk || that_present_bonk) {
            if (!(this_present_bonk && that_present_bonk)) return false;
            if (!this.bonk.equals(that.bonk)) return false;
        }
    ...
    public int hashCode() {
        ...
        if (isSetBonk()) hashCode = hashCode * 8191 + bonk.hashCode();
    ...
    private static class NestedListsBonkStandardScheme
            extends org.apache.thrift.scheme.StandardScheme<NestedListsBonk> {

        @Override
        public void read(org.apache.thrift.protocol.TProtocol iprot, NestedListsBonk struct)
                        ...
                        if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                            {
                                ...
                                struct.bonk =
                                        new java.util.ArrayList<java.util.List<java.util.List<Bonk>>>(_list264.size);
        ...
        @Override
        public void write(org.apache.thrift.protocol.TProtocol oprot, NestedListsBonk struct)
                throws org.apache.thrift.TException {
            struct.validate();
            ...
            if (struct.bonk != null) {
                oprot.writeFieldBegin(BONK_FIELD_DESC);
                {
                    oprot.writeListBegin(new org.apache.thrift.protocol.TList(
                            org.apache.thrift.protocol.TType.LIST, struct.bonk.size()));
                    for (java.util.List<java.util.List<Bonk>> _iter273 : struct.bonk) {
                        {
                            oprot.writeListBegin(new org.apache.thrift.protocol.TList(
                                    org.apache.thrift.protocol.TType.LIST, _iter273.size()));
                            for (java.util.List<Bonk> _iter274 : _iter273) {
                                {
                                    oprot.writeListBegin(new org.apache.thrift.protocol.TList(
                                            org.apache.thrift.protocol.TType.STRUCT, _iter274.size()));
    ...
    private static class NestedListsBonkTupleScheme extends org.apache.thrift.scheme.TupleScheme<NestedListsBonk> {
        ...
        @Override
        public void write(org.apache.thrift.protocol.TProtocol prot, NestedListsBonk struct)
                throws org.apache.thrift.TException {
        ...
        @Override
        public void read(org.apache.thrift.protocol.TProtocol prot, NestedListsBonk struct)
                throws org.apache.thrift.TException {
            org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
            java.util.BitSet incoming = iprot.readBitSet(1);
            if (incoming.get(0)) {
                {
                    org.apache.thrift.protocol.TList _list279 =
                    ...
                    for (int _i281 = 0; _i281 < _list279.size; ++_i281) {
                        {
                            org.apache.thrift.protocol.TList _list282 =
                                    iprot.readListBegin(org.apache.thrift.protocol.TType.LIST);
                            ...
                            for (int _i284 = 0; _i284 < _list282.size; ++_i284) {
                                {
                                    org.apache.thrift.protocol.TList _list285 =
