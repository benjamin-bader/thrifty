...
public class CrazyNesting
        implements org.apache.thrift.TBase<CrazyNesting, CrazyNesting._Fields>,
                java.io.Serializable,
                Cloneable,
                Comparable<CrazyNesting> {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC =
            new org.apache.thrift.protocol.TStruct("CrazyNesting");

    private static final org.apache.thrift.protocol.TField STRING_FIELD_FIELD_DESC =
            new org.apache.thrift.protocol.TField("string_field", org.apache.thrift.protocol.TType.STRING, (short) 1);
    private static final org.apache.thrift.protocol.TField SET_FIELD_FIELD_DESC =
            new org.apache.thrift.protocol.TField("set_field", org.apache.thrift.protocol.TType.SET, (short) 2);
    private static final org.apache.thrift.protocol.TField LIST_FIELD_FIELD_DESC =
            new org.apache.thrift.protocol.TField("list_field", org.apache.thrift.protocol.TType.LIST, (short) 3);
    private static final org.apache.thrift.protocol.TField BINARY_FIELD_FIELD_DESC =
            new org.apache.thrift.protocol.TField("binary_field", org.apache.thrift.protocol.TType.STRING, (short) 4);

    private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY =
            new CrazyNestingStandardSchemeFactory();
    private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY =
            new CrazyNestingTupleSchemeFactory();
    ...
    public @org.apache.thrift.annotation.Nullable java.util.List<
                    java.util.Map<
                            ...
                            java.util.Map<
                                    java.lang.Integer,
                                    java.util.Set<java.util.List<java.util.Map<Insanity, java.lang.String>>>>>>
            list_field; // required
                ...
                new org.apache.thrift.meta_data.FieldMetaData(
                        ...
                        new org.apache.thrift.meta_data.SetMetaData(
                                ...
                                new org.apache.thrift.meta_data.StructMetaData(
                                        org.apache.thrift.protocol.TType.STRUCT, Insanity.class))));
        tmpMap.put(
                _Fields.LIST_FIELD,
                new org.apache.thrift.meta_data.FieldMetaData(
                        "list_field",
            ...
            java.util.List<
                            java.util.Map<
                                    ...
                                    java.util.Map<
                                            java.lang.Integer,
                                            java.util.Set<java.util.List<java.util.Map<Insanity, java.lang.String>>>>>>
                    __this__list_field = new java.util.ArrayList<
                            java.util.Map<
                                    java.util.Set<java.lang.Integer>,
                                    java.util.Map<
                                            java.lang.Integer,
                                            java.util.Set<java.util.List<java.util.Map<Insanity, java.lang.String>>>>>>(
                            other.list_field.size());
            for (java.util.Map<
                            java.util.Set<java.lang.Integer>,
                            java.util.Map<
                                    java.lang.Integer,
                                    java.util.Set<java.util.List<java.util.Map<Insanity, java.lang.String>>>>>
                    other_element : other.list_field) {
                java.util.Map<
                                java.util.Set<java.lang.Integer>,
                                java.util.Map<
                                        java.lang.Integer,
                                        java.util.Set<java.util.List<java.util.Map<Insanity, java.lang.String>>>>>
                        __this__list_field_copy = new java.util.HashMap<
                                java.util.Set<java.lang.Integer>,
                                java.util.Map<
                                        java.lang.Integer,
                                        java.util.Set<java.util.List<java.util.Map<Insanity, java.lang.String>>>>>(
                ...
                for (java.util.Map.Entry<
                                ...
                                java.util.Map<
                                        java.lang.Integer,
                                        java.util.Set<java.util.List<java.util.Map<Insanity, java.lang.String>>>>>
                        other_element_element : other_element.entrySet()) {

                    java.util.Set<java.lang.Integer> other_element_element_key = other_element_element.getKey();
                    java.util.Map<
                                    java.lang.Integer,
                                    java.util.Set<java.util.List<java.util.Map<Insanity, java.lang.String>>>>
                            other_element_element_value = other_element_element.getValue();

                    java.util.Set<java.lang.Integer> __this__list_field_copy_copy_key =
                            new java.util.HashSet<java.lang.Integer>(other_element_element_key);

                    java.util.Map<
                                    java.lang.Integer,
                                    java.util.Set<java.util.List<java.util.Map<Insanity, java.lang.String>>>>
                            __this__list_field_copy_copy_value = new java.util.HashMap<
                                    java.lang.Integer,
                                    java.util.Set<java.util.List<java.util.Map<Insanity, java.lang.String>>>>(
                                    other_element_element_value.size());
                    for (java.util.Map.Entry<
                                    java.lang.Integer,
                                    java.util.Set<java.util.List<java.util.Map<Insanity, java.lang.String>>>>
                            other_element_element_value_element : other_element_element_value.entrySet()) {

                        java.lang.Integer other_element_element_value_element_key =
                                other_element_element_value_element.getKey();
                        java.util.Set<java.util.List<java.util.Map<Insanity, java.lang.String>>>
                                other_element_element_value_element_value =
                                        other_element_element_value_element.getValue();

                        java.lang.Integer __this__list_field_copy_copy_value_copy_key =
                                other_element_element_value_element_key;

                        java.util.Set<java.util.List<java.util.Map<Insanity, java.lang.String>>>
                                __this__list_field_copy_copy_value_copy_value = new java.util.HashSet<
                                        java.util.List<java.util.Map<Insanity, java.lang.String>>>(
                                        other_element_element_value_element_value.size());
                        for (java.util.List<java.util.Map<Insanity, java.lang.String>>
                                other_element_element_value_element_value_element :
                                        other_element_element_value_element_value) {
                            java.util.List<java.util.Map<Insanity, java.lang.String>>
                                    __this__list_field_copy_copy_value_copy_value_copy =
                                            new java.util.ArrayList<java.util.Map<Insanity, java.lang.String>>(
                                                    other_element_element_value_element_value_element.size());
                            for (java.util.Map<Insanity, java.lang.String>
                                    other_element_element_value_element_value_element_element :
                                            other_element_element_value_element_value_element) {
                                java.util.Map<Insanity, java.lang.String>
                                        __this__list_field_copy_copy_value_copy_value_copy_copy = new java.util.HashMap<
                                                Insanity, java.lang.String>(
                                                other_element_element_value_element_value_element_element.size());
                                for (java.util.Map.Entry<Insanity, java.lang.String>
                                        other_element_element_value_element_value_element_element_element :
                                                other_element_element_value_element_value_element_element.entrySet()) {

                                    Insanity other_element_element_value_element_value_element_element_element_key =
                                            other_element_element_value_element_value_element_element_element.getKey();
                                    java.lang.String
                                    ...
                                    Insanity __this__list_field_copy_copy_value_copy_value_copy_copy_copy_key =
                                            new Insanity(
                                                    other_element_element_value_element_value_element_element_element_key);

                                    java.lang.String
                                            __this__list_field_copy_copy_value_copy_value_copy_copy_copy_value =
                                                    other_element_element_value_element_value_element_element_element_value;

                                    __this__list_field_copy_copy_value_copy_value_copy_copy.put(
                                            __this__list_field_copy_copy_value_copy_value_copy_copy_copy_key,
                                            __this__list_field_copy_copy_value_copy_value_copy_copy_copy_value);
                                }
                                __this__list_field_copy_copy_value_copy_value_copy.add(
                                        __this__list_field_copy_copy_value_copy_value_copy_copy);
                            }
                            __this__list_field_copy_copy_value_copy_value.add(
                                    __this__list_field_copy_copy_value_copy_value_copy);
                        }

                        __this__list_field_copy_copy_value.put(
                                __this__list_field_copy_copy_value_copy_key,
                                __this__list_field_copy_copy_value_copy_value);
                    }
    ...
    public void addToList_field(
        ...
        if (this.list_field == null) {
            this.list_field = new java.util.ArrayList<
                    java.util.Map<
                            java.util.Set<java.lang.Integer>,
                            java.util.Map<
                                    java.lang.Integer,
    ...
    public CrazyNesting setList_field(
            @org.apache.thrift.annotation.Nullable
                    java.util.List<
                                    java.util.Map<
                                            java.util.Set<java.lang.Integer>,
    ...
    public CrazyNesting setBinary_field(byte[] binary_field) {
        this.binary_field =
                binary_field == null ? (java.nio.ByteBuffer) null : java.nio.ByteBuffer.wrap(binary_field.clone());
        return this;
    }
    ...
    public boolean equals(java.lang.Object that) {
        if (that instanceof CrazyNesting) return this.equals((CrazyNesting) that);
        return false;
    }
    ...
    public boolean equals(CrazyNesting that) {
        ...
        if (this_present_string_field || that_present_string_field) {
            if (!(this_present_string_field && that_present_string_field)) return false;
            if (!this.string_field.equals(that.string_field)) return false;
        }
        ...
        if (this_present_set_field || that_present_set_field) {
            if (!(this_present_set_field && that_present_set_field)) return false;
            if (!this.set_field.equals(that.set_field)) return false;
        }
        ...
        if (this_present_list_field || that_present_list_field) {
            if (!(this_present_list_field && that_present_list_field)) return false;
            if (!this.list_field.equals(that.list_field)) return false;
        }
        ...
        if (this_present_binary_field || that_present_binary_field) {
            if (!(this_present_binary_field && that_present_binary_field)) return false;
            if (!this.binary_field.equals(that.binary_field)) return false;
        }
    ...
    public int hashCode() {
        ...
        if (isSetString_field()) hashCode = hashCode * 8191 + string_field.hashCode();

        hashCode = hashCode * 8191 + ((isSetSet_field()) ? 131071 : 524287);
        if (isSetSet_field()) hashCode = hashCode * 8191 + set_field.hashCode();

        hashCode = hashCode * 8191 + ((isSetList_field()) ? 131071 : 524287);
        if (isSetList_field()) hashCode = hashCode * 8191 + list_field.hashCode();

        hashCode = hashCode * 8191 + ((isSetBinary_field()) ? 131071 : 524287);
        if (isSetBinary_field()) hashCode = hashCode * 8191 + binary_field.hashCode();
    ...
    public void validate() throws org.apache.thrift.TException {
        ...
        if (list_field == null) {
            throw new org.apache.thrift.protocol.TProtocolException(
                    "Required field 'list_field' was not present! Struct: " + toString());
        }
                        ...
                        if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                            {
                                ...
                                struct.list_field = new java.util.ArrayList<
                                        java.util.Map<
                                                java.util.Set<java.lang.Integer>,
                                                java.util.Map<
                                                        java.lang.Integer,
                                                        ...
                                                        for (int _i37 = 0; _i37 < _set35.size; ++_i37) {
                                                            {
                                                                org.apache.thrift.protocol.TList _list38 =
                                                                        iprot.readListBegin();
                                                                _elem36 = new java.util.ArrayList<
                                                                        java.util.Map<Insanity, java.lang.String>>(
                                                                        _list38.size);
                                                                @org.apache.thrift.annotation.Nullable
                                                                ...
                                                                for (int _i40 = 0; _i40 < _list38.size; ++_i40) {
                                                                    {
                                                                        org.apache.thrift.protocol.TMap _map41 =
                                                                                iprot.readMapBegin();
                                                                        _elem39 = new java.util.HashMap<
                                                                                Insanity, java.lang.String>(
                                                                                2 * _map41.size);
                                                                        @org.apache.thrift.annotation.Nullable
                                                                        Insanity _key42;
                            ...
                            for (java.util.Map.Entry<
                                ...
                                }
                                {
                                    ...
                                    for (java.util.Map.Entry<
                                                    ...
                                                    java.util.Set<
                                                            java.util.List<java.util.Map<Insanity, java.lang.String>>>>
                                            _iter49 : _iter47.getValue().entrySet()) {
                                        oprot.writeI32(_iter49.getKey());
                                        {
                                            oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(
                                                    org.apache.thrift.protocol.TType.LIST,
                                                    _iter49.getValue().size()));
                                            for (java.util.List<java.util.Map<Insanity, java.lang.String>> _iter50 :
                                                    _iter49.getValue()) {
                                                {
                                                    oprot.writeListBegin(new org.apache.thrift.protocol.TList(
    ...
    private static class CrazyNestingTupleScheme extends org.apache.thrift.scheme.TupleScheme<CrazyNesting> {
        ...
        @Override
        public void write(org.apache.thrift.protocol.TProtocol prot, CrazyNesting struct)
                throws org.apache.thrift.TException {
                        ...
                        for (java.util.Map.Entry<
                            ...
                            }
                            {
                                ...
                                for (java.util.Map.Entry<
                                                ...
                                                java.util.Set<
                                                        java.util.List<java.util.Map<Insanity, java.lang.String>>>>
                                        _iter56 : _iter54.getValue().entrySet()) {
                                    oprot.writeI32(_iter56.getKey());
                                    {
                                        oprot.writeI32(_iter56.getValue().size());
                                        for (java.util.List<java.util.Map<Insanity, java.lang.String>> _iter57 :
                                                _iter56.getValue()) {
                                            {
                                                ...
                                                for (java.util.Map<Insanity, java.lang.String> _iter58 : _iter57) {
                                                    {
                                                        ...
                                                        for (java.util.Map.Entry<Insanity, java.lang.String> _iter59 :
                                                                _iter58.entrySet()) {
        ...
        @Override
        public void read(org.apache.thrift.protocol.TProtocol prot, CrazyNesting struct)
                throws org.apache.thrift.TException {
                ...
                for (int _i63 = 0; _i63 < _list61.size; ++_i63) {
                    {
                        org.apache.thrift.protocol.TMap _map64 = iprot.readMapBegin(
                                org.apache.thrift.protocol.TType.SET, org.apache.thrift.protocol.TType.MAP);
                        _elem62 = new java.util.HashMap<
                                java.util.Set<java.lang.Integer>,
                                java.util.Map<
                                        java.lang.Integer,
                                        java.util.Set<java.util.List<java.util.Map<Insanity, java.lang.String>>>>>(
                        ...
                        for (int _i67 = 0; _i67 < _map64.size; ++_i67) {
                            ...
                            }
                            {
                                ...
                                for (int _i74 = 0; _i74 < _map71.size; ++_i74) {
                                    ...
                                    {
                                        org.apache.thrift.protocol.TSet _set75 =
                                                iprot.readSetBegin(org.apache.thrift.protocol.TType.LIST);
                                        _val73 = new java.util.HashSet<
                                                java.util.List<java.util.Map<Insanity, java.lang.String>>>(
                                                2 * _set75.size);
                                        @org.apache.thrift.annotation.Nullable
                                        ...
                                        for (int _i77 = 0; _i77 < _set75.size; ++_i77) {
                                            {
                                                ...
                                                _elem76 = new java.util.ArrayList<
                                                        java.util.Map<Insanity, java.lang.String>>(_list78.size);
                                                @org.apache.thrift.annotation.Nullable
                                                ...
                                                for (int _i80 = 0; _i80 < _list78.size; ++_i80) {
                                                    {
                                                        org.apache.thrift.protocol.TMap _map81 = iprot.readMapBegin(
                                                                org.apache.thrift.protocol.TType.STRUCT,
                                                                org.apache.thrift.protocol.TType.STRING);
                                                        _elem79 = new java.util.HashMap<Insanity, java.lang.String>(
                                                                2 * _map81.size);
