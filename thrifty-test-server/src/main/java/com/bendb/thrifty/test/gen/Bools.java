...
public class Bools
        implements org.apache.thrift.TBase<Bools, Bools._Fields>, java.io.Serializable, Cloneable, Comparable<Bools> {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC =
            new org.apache.thrift.protocol.TStruct("Bools");

    private static final org.apache.thrift.protocol.TField IM_TRUE_FIELD_DESC =
            new org.apache.thrift.protocol.TField("im_true", org.apache.thrift.protocol.TType.BOOL, (short) 1);
    private static final org.apache.thrift.protocol.TField IM_FALSE_FIELD_DESC =
            new org.apache.thrift.protocol.TField("im_false", org.apache.thrift.protocol.TType.BOOL, (short) 2);

    private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY =
            new BoolsStandardSchemeFactory();
    ...
    public Bools(boolean im_true, boolean im_false) {
        this();
    ...
    public boolean equals(java.lang.Object that) {
        if (that instanceof Bools) return this.equals((Bools) that);
        return false;
    }
    ...
    public boolean equals(Bools that) {
        ...
        if (this_present_im_true || that_present_im_true) {
            if (!(this_present_im_true && that_present_im_true)) return false;
            if (this.im_true != that.im_true) return false;
        }

        boolean this_present_im_false = true;
        boolean that_present_im_false = true;
        if (this_present_im_false || that_present_im_false) {
            if (!(this_present_im_false && that_present_im_false)) return false;
            if (this.im_false != that.im_false) return false;
        }
    ...
    private static class BoolsStandardScheme extends org.apache.thrift.scheme.StandardScheme<Bools> {
        ...
        @Override
        public void write(org.apache.thrift.protocol.TProtocol oprot, Bools struct)
