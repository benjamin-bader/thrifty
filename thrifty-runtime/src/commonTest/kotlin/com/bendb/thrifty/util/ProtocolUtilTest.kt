...
class ProtocolUtilTest {
    ...
    @Test
    fun skipConsumesStructs() = runTest {
    ...
    @Test
    fun throwsProtocolExceptionOnUnknownTTypeValue() = runTest {
