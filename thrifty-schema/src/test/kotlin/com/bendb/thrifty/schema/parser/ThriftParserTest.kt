...
class ThriftParserTest {
  ...
  @BeforeEach
  fun setup() {
    ThriftyParserPlugins.setUUIDProvider(
        object : ThriftyParserPlugins.UUIDProvider {
  ...
  fun includes() {
    ...
    val expected =
        ThriftFileElement(
            ...
            namespaces = listOf(NamespaceElement(location.at(5, 1), NamespaceScope.ALL, "bendb")))
            ...
            typedefs =
                listOf(
                    TypedefElement(
                        ...
                        oldType =
                            ListTypeElement(
                                location.at(1, 9), ScalarTypeElement(location.at(1, 14), "i32")),
                        newName = "IntList"),
                    TypedefElement(
                        location = location.at(2, 1),
                        oldType =
                            SetTypeElement(
                                location.at(2, 9), ScalarTypeElement(location.at(2, 13), "string")),
                        newName = "Names"),
                    TypedefElement(
                        location = location.at(3, 1),
                        oldType =
  ...
  fun weirdFieldPermutations() {
    ...
    val expected = ThriftFileElement(location = location, structs = listOf(expectedStruct))
                                    ...
                                    exceptions =
                                        listOf(
                                            FieldElement(
                                                ...
                                                fieldId = 1,
                                                type =
                                                    ScalarTypeElement(location.at(3, 16), "Blargh"),
                                                name = "blah",
                                                requiredness = Requiredness.DEFAULT))),
                                FunctionElement(
                                    location = location.at(4, 3),
  ...
  fun listConst() {
    ...
    val expected = ThriftFileElement(location = location, constants = listOf(element))
  ...
  fun mapConst() {
    ...
    val expected = ThriftFileElement(location = location, constants = listOf(mapConst))
  ...
  fun annotationsOnServices() {
    val thrift =
        "" + "service Svc {" + "  void foo(1: i32 bar)" + "} (async = 'true', java.races = 'false')"
  ...
  fun `top-level semicolons are a syntax error`() {
    ...
    ex.message.shouldContain(
        "extraneous input ';'") // reenable when we have improved syntax error reporting
  }
