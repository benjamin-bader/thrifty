...
/**
 * Represents a 'structured' type in Thrift. A StructType could be any of 'struct', 'union', or
 * 'exception'.
 */
class StructType : UserType {
  ...
  class Builder internal constructor(type: StructType) :
      UserType.UserTypeBuilder<StructType, Builder>(type) {
    ...
    fun structType(structType: StructElement.Type): Builder = apply { this.structType = structType }

    /** Use the given [fields] for the type under construction. */
    fun fields(fields: List<Field>): Builder = apply { this.fields = fields.toList() }
