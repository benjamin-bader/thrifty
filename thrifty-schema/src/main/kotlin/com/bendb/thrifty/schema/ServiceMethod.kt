...
private constructor(
  ...
  val resultStruct =
      StructType(
          StructElement(
              ...
              element.exceptions +
                  if (element.returnType.name == BuiltinType.VOID.name) emptyList()
                  else listOf(FieldElement(element.location, 0, element.returnType, "success"))),
          mixin.namespaces)
  ...
  class Builder internal constructor(method: ServiceMethod) :
    ...
    fun returnType(type: ThriftType): Builder = apply { returnType = type }
