...
/**
 * Invokes the action from all the elements separated using [separator] and using the given [prefix]
 ...
 * defaults to "...").
 *
 * This is slightly modified form of [Iterable.joinTo] but does not transform each element to a
 * string. Instead the buffer is passed to the [action] so that it can run its own additions to the
 * [buffer].
 */
