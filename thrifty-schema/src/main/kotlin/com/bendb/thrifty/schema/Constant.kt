...
private constructor(
  ...
  private constructor(builder: Builder) : this(builder.element, builder.mixin, builder.type)
  ...
  class Builder internal constructor(constant: Constant) :
  ...
  private object Validators {
    ...
    private val BYTE =
        IntegerValidator(java.lang.Byte.MIN_VALUE.toLong(), java.lang.Byte.MAX_VALUE.toLong())
    private val I16 =
        IntegerValidator(java.lang.Short.MIN_VALUE.toLong(), java.lang.Short.MAX_VALUE.toLong())
  ...
  private class IntegerValidator(private val minValue: Long, private val maxValue: Long) :
      BaseValidator() {
    override fun validate(
        symbolTable: SymbolTable,
        expected: ThriftType,
    ...
    override fun validate(
      ...
      when (valueElement) {
        ...
        is IdentifierValueElement -> {
          ...
          // 3. An imported, partially-qualified enum value, e.g. Enum.Member (where Enum is
          // imported)
  ...
  private object StructValidator : BaseValidator() {
    override fun validate(
      ...
      if (valueElement
          is MapValueElement) { // struct valued constants should always be defined as a Map
