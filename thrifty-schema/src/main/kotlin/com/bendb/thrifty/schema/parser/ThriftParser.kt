...
/** A simple driver for the generated ANTLR Thrift parser; parses single .thrift documents. */
object ThriftParser {

  /**
   * Parse the given Thrift [text], using the given [location] to anchor parsed elements within the
   * file.
   *
