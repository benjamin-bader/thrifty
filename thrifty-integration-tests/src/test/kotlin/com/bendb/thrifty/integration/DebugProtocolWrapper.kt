...
/**
 * A [Protocol] wrapper that prints each method as it is invoked, which is helpful when debugging
 * client-server errors from generated code.
 */
class DebugProtocolWrapper(private val protocol: Protocol) : Protocol by protocol {
